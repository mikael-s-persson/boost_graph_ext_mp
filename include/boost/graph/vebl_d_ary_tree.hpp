...
class vebl_d_ary_tree {
 public:
  ...
  typedef graph::detail::bfltree_value_type<vertex_property_type,
                                            edge_property_type>
      value_type;
  ...
  typedef graph::detail::vebltree_edge_validity<container_type, Arity>
      edge_validity;
  typedef filter_iterator<edge_validity, graph::detail::bfltree_eiter>
      edge_iterator;
  typedef edge_iterator out_edge_iterator;
  typedef graph::detail::bfltree_eiter in_edge_iterator;

  typedef graph::detail::vebltree_vertex_validity<container_type, Arity>
      vertex_validity;
  typedef filter_iterator<vertex_validity, graph::detail::bfltree_viter>
      vertex_iterator;
...
struct property_map<BGL_VEBL_D_ARY_TREE, T Bundle::*> {
  ...
  typedef is_convertible<typename BGL_VEBL_D_ARY_TREE::vertex_bundled*,
                         non_const_Bundle*>
      is_vertex_bundle;
  typedef bundle_member_property_map<
      non_const_T, BGL_VEBL_D_ARY_TREE,
      typename mpl::if_<is_vertex_bundle, vertex_bundle_t, edge_bundle_t>::type>
      type;
  typedef bundle_member_property_map<
      const non_const_T, const BGL_VEBL_D_ARY_TREE,
      typename mpl::if_<is_vertex_bundle, vertex_bundle_t, edge_bundle_t>::type>
      const_type;
};
