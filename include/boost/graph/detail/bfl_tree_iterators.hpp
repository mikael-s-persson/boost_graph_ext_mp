...
struct bfltree_value_type
    : bfltree_vertex_value_base<VertexProperties,
                                is_empty<VertexProperties>::value>,
...
struct bfltree_vertex_validity {
  ...
  explicit bfltree_vertex_validity(const Container* aPCont = NULL)
      : p_cont(aPCont){};
...
struct bfltree_edge_validity {
  const Container* p_cont;
  explicit bfltree_edge_validity(const Container* aPCont = NULL)
      : p_cont(aPCont){};
