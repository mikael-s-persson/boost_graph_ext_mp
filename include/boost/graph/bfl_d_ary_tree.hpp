...
class bfl_d_ary_tree {
 public:
  ...
  typedef graph::detail::bfltree_vertex_validity<container_type>
      vertex_validity;
...
typename BGL_BFL_D_ARY_TREE::vertex_descriptor source(
    typename BGL_BFL_D_ARY_TREE::edge_descriptor e, const BGL_BFL_D_ARY_TREE&) {
...
struct property_map<BGL_BFL_D_ARY_TREE, T Bundle::*> {
  ...
  typedef is_convertible<typename BGL_BFL_D_ARY_TREE::vertex_bundled*,
                         non_const_Bundle*>
      is_vertex_bundle;
  typedef bundle_member_property_map<
      non_const_T, BGL_BFL_D_ARY_TREE,
      typename mpl::if_<is_vertex_bundle, vertex_bundle_t, edge_bundle_t>::type>
      type;
  typedef bundle_member_property_map<
      const non_const_T, const BGL_BFL_D_ARY_TREE,
      typename mpl::if_<is_vertex_bundle, vertex_bundle_t, edge_bundle_t>::type>
      const_type;
};
