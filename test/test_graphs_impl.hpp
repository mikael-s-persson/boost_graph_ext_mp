...
check_graph_vertex_count(const Graph&, std::size_t){};
...
template <typename Graph>
typename disable_if<is_vertex_list_graph<Graph>, void>::type
intint_check_graph_vertex_values(const Graph&, std::size_t, const int*){};
...
check_graph_edge_count(const Graph&, std::size_t){};
...
template <typename Graph>
typename disable_if<is_edge_list_graph<Graph>, void>::type
intint_check_graph_edge_values(const Graph&, std::size_t, const int*){};
...
check_graph_in_degree(const Graph&,
...
template <typename Graph>
typename disable_if<is_bidirectional_graph<Graph>, void>::type
check_graph_in_edge_values(const Graph&,
                           typename graph_traits<Graph>::vertex_descriptor,
...
check_graph_out_degree(const Graph&,
                       typename graph_traits<Graph>::vertex_descriptor,
                       std::size_t){};
...
template <typename Graph>
typename disable_if<is_incidence_graph<Graph>, void>::type
check_graph_out_edge_values(const Graph&,
                            typename graph_traits<Graph>::vertex_descriptor,
                            std::size_t, const int*, const int*){};
...
intint_check_fullbranch_integrity(
    const Graph& g, typename graph_traits<Graph>::vertex_descriptor) {
  typedef typename graph_traits<Graph>::out_edge_iterator OutEdgeIter;
  typedef typename graph_traits<Graph>::vertex_iterator VertexIter;
