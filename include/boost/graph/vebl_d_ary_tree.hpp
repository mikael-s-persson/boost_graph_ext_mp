...
class vebl_d_ary_tree {
 public:
  ...
  using edge_validity =
      graph::detail::vebltree_edge_validity<container_type, Arity>;
  using edge_iterator =
  ...
  using vertex_validity =
      graph::detail::vebltree_vertex_validity<container_type, Arity>;
  ...
  value_type& get_vertex_value_impl(vertex_descriptor v) {
    return m_vertices[graph::detail::convert_bfl_to_vebl<Arity>(v,
                                                                m_depth_recs)];
  }
  ...
  static vertex_descriptor get_child_impl(vertex_descriptor v,
                                          std::size_t edge_id) {
  ...
  /**
     ...
     */
  explicit vebl_d_ary_tree(vertices_size_type aDepth = 0) {
  ...
  std::pair<vertex_descriptor, edge_descriptor> add_child(vertex_descriptor v,
    ...
    if ((v >= m_vertices.size()) ||
        !graph::detail::bfltree_is_vertex_valid(get_vertex_value_impl(v))) {
      return {null_vertex(), edge_descriptor(null_vertex())};
    }
    vertex_descriptor result = get_child_impl(v, 0);
    for (; result < get_child_impl(v, Arity); ++result) {
      if ((result >= m_vertices.size()) ||
          !graph::detail::bfltree_is_vertex_valid(
              get_vertex_value_impl(result))) {
        break;
      }
    }
  ...
  void clear_children_impl(vertex_descriptor v, VertexOIter& vit_out,
    ...
    if (v !=
        0) {  // if the node is not the root one, then update the out-degree of the parent node:
...
#define BGL_VEBL_D_ARY_TREE_ARGS \
  std::size_t Arity, typename VertexProperties, typename EdgeProperties
#define BGL_VEBL_D_ARY_TREE \
  vebl_d_ary_tree<Arity, VertexProperties, EdgeProperties>
...
void swap(BGL_VEBL_D_ARY_TREE& lhs, BGL_VEBL_D_ARY_TREE& rhs) {
  lhs.swap(rhs);
}
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertex_descriptor source(
    typename BGL_VEBL_D_ARY_TREE::edge_descriptor e,
    const BGL_VEBL_D_ARY_TREE& /*unused*/) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertex_descriptor target(
    typename BGL_VEBL_D_ARY_TREE::edge_descriptor e,
    const BGL_VEBL_D_ARY_TREE& /*unused*/) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::out_edge_iterator,
          typename BGL_VEBL_D_ARY_TREE::out_edge_iterator>
out_edges(const typename BGL_VEBL_D_ARY_TREE::vertex_descriptor& v,
          const BGL_VEBL_D_ARY_TREE& g) {
  using OutIter = typename vebl_d_ary_tree<Arity, VertexProperties,
                                           EdgeProperties>::out_edge_iterator;
  using RawContainer = typename vebl_d_ary_tree<Arity, VertexProperties,
  ...
  return std::pair<OutIter, OutIter>(
      OutIter(graph::detail::vebltree_edge_validity<RawContainer, Arity>(
                  &g.m_vertices, &g.m_depth_recs),
              v_beg, v_end),
      OutIter(graph::detail::vebltree_edge_validity<RawContainer, Arity>(
                  &g.m_vertices, &g.m_depth_recs),
              v_end, v_end));
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::size_t out_degree(const typename BGL_VEBL_D_ARY_TREE::vertex_descriptor& v,
                       const BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::in_edge_iterator,
          typename BGL_VEBL_D_ARY_TREE::in_edge_iterator>
in_edges(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
         const BGL_VEBL_D_ARY_TREE& g) {
  using InIter = typename vebl_d_ary_tree<Arity, VertexProperties,
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::size_t in_degree(const typename BGL_VEBL_D_ARY_TREE::vertex_descriptor& v,
                      const BGL_VEBL_D_ARY_TREE& g) {
  if (v == 0) {
    return 0;
  }
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::size_t degree(const typename BGL_VEBL_D_ARY_TREE::vertex_descriptor& v,
                   const BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::vertex_iterator,
          typename BGL_VEBL_D_ARY_TREE::vertex_iterator>
vertices(const BGL_VEBL_D_ARY_TREE& g) {
  using VIter = typename vebl_d_ary_tree<Arity, VertexProperties,
  ...
  return std::pair<VIter, VIter>(
      VIter(graph::detail::vebltree_vertex_validity<RawContainer, Arity>(
                &g.m_vertices, &g.m_depth_recs),
            v_beg, v_end),
      VIter(graph::detail::vebltree_vertex_validity<RawContainer, Arity>(
                &g.m_vertices, &g.m_depth_recs),
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertices_size_type num_vertices(
    const BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::edge_iterator,
          typename BGL_VEBL_D_ARY_TREE::edge_iterator>
edges(const BGL_VEBL_D_ARY_TREE& g) {
  using EIter = typename vebl_d_ary_tree<Arity, VertexProperties,
  ...
  return std::pair<EIter, EIter>(
      EIter(graph::detail::vebltree_edge_validity<RawContainer, Arity>(
                &g.m_vertices, &g.m_depth_recs),
            v_beg, v_end),
      EIter(graph::detail::vebltree_edge_validity<RawContainer, Arity>(
                &g.m_vertices, &g.m_depth_recs),
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertices_size_type num_edges(
    const BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::edge_descriptor, bool> edge(
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor u,
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
    const BGL_VEBL_D_ARY_TREE& /*unused*/) {
  using Edge = typename vebl_d_ary_tree<Arity, VertexProperties,
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertex_descriptor get_root_vertex(
    const BGL_VEBL_D_ARY_TREE& g) {
  return 0;
}
...
std::pair<typename BGL_VEBL_D_ARY_TREE::vertex_iterator,
          typename BGL_VEBL_D_ARY_TREE::vertex_iterator>
child_vertices(const typename BGL_VEBL_D_ARY_TREE::vertex_descriptor& v,
               const BGL_VEBL_D_ARY_TREE& g) {
  using VIter = typename vebl_d_ary_tree<Arity, VertexProperties,
                                         EdgeProperties>::vertex_iterator;
  using RawContainer = typename vebl_d_ary_tree<Arity, VertexProperties,
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::adjacency_iterator,
          typename BGL_VEBL_D_ARY_TREE::adjacency_iterator>
adjacent_vertices(const typename BGL_VEBL_D_ARY_TREE::vertex_descriptor& v,
                  const BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertex_descriptor parent_vertex(
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
    const BGL_VEBL_D_ARY_TREE& /*unused*/) {
  if (v == 0) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::inv_adjacency_iterator,
          typename BGL_VEBL_D_ARY_TREE::inv_adjacency_iterator>
inv_adjacent_vertices(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
                      const BGL_VEBL_D_ARY_TREE& g) {
  using InvAdjIter =
      typename vebl_d_ary_tree<Arity, VertexProperties,
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
void remove_branch(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
void clear_children(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
                    BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertex_descriptor create_root(
    BGL_VEBL_D_ARY_TREE& g) {
 ...
 */
template <BGL_VEBL_D_ARY_TREE_ARGS>
std::pair<typename BGL_VEBL_D_ARY_TREE::vertex_descriptor,
          typename BGL_VEBL_D_ARY_TREE::edge_descriptor>
add_child_vertex(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
                 BGL_VEBL_D_ARY_TREE& g) {
  using VProp = typename vebl_d_ary_tree<Arity, VertexProperties,
                                         EdgeProperties>::vertex_property_type;
  using EProp = typename vebl_d_ary_tree<Arity, VertexProperties,
...
typename BGL_VEBL_D_ARY_TREE::vertex_descriptor create_root(
    VProp&& vp, BGL_VEBL_D_ARY_TREE& g) {
  if (graph::detail::bfltree_is_vertex_valid(g.m_vertices[0])) {
    remove_branch(0, g);
  }
  g.m_vertices[0].out_degree = 0;
...
std::pair<typename BGL_VEBL_D_ARY_TREE::vertex_descriptor,
          typename BGL_VEBL_D_ARY_TREE::edge_descriptor>
add_child_vertex(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v, VProp&& vp,
                 BGL_VEBL_D_ARY_TREE& g) {
  using EProp = typename vebl_d_ary_tree<Arity, VertexProperties,
                                         EdgeProperties>::edge_property_type;
...
std::pair<typename BGL_VEBL_D_ARY_TREE::vertex_descriptor,
          typename BGL_VEBL_D_ARY_TREE::edge_descriptor>
add_child_vertex(typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v, VProp&& vp,
                 EProp&& ep, BGL_VEBL_D_ARY_TREE& g) {
...
std::pair<VertexOIter, EdgeOIter> remove_branch(
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v, VertexOIter vit_out,
    EdgeOIter eit_out, BGL_VEBL_D_ARY_TREE& g) {
...
/**
  ...
  */
template <BGL_VEBL_D_ARY_TREE_ARGS>
const typename BGL_VEBL_D_ARY_TREE::vertex_property_type& get(
    const BGL_VEBL_D_ARY_TREE& g,
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v) {
  return g[v];
}
...
/**
  ...
  */
template <BGL_VEBL_D_ARY_TREE_ARGS>
const typename BGL_VEBL_D_ARY_TREE::edge_property_type& get(
    const BGL_VEBL_D_ARY_TREE& g,
    typename BGL_VEBL_D_ARY_TREE::edge_descriptor e) {
  return g[e];
}
...
/**
  ...
  */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::vertex_property_type& get_property(
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v, BGL_VEBL_D_ARY_TREE& g) {
  return g[v];
}
...
/**
  ...
  */
template <BGL_VEBL_D_ARY_TREE_ARGS>
const typename BGL_VEBL_D_ARY_TREE::vertex_property_type& get_property(
    typename BGL_VEBL_D_ARY_TREE::vertex_descriptor v,
    const BGL_VEBL_D_ARY_TREE& g) {
  return g[v];
}
...
/**
  ...
  */
template <BGL_VEBL_D_ARY_TREE_ARGS>
typename BGL_VEBL_D_ARY_TREE::edge_property_type& get_property(
    typename BGL_VEBL_D_ARY_TREE::edge_descriptor e, BGL_VEBL_D_ARY_TREE& g) {
  return g[e];
}
...
/**
  ...
  */
template <BGL_VEBL_D_ARY_TREE_ARGS>
const typename BGL_VEBL_D_ARY_TREE::edge_property_type& get_property(
    typename BGL_VEBL_D_ARY_TREE::edge_descriptor e,
    const BGL_VEBL_D_ARY_TREE& g) {
  return g[e];
}
...
struct property_map<BGL_VEBL_D_ARY_TREE, T Bundle::*> {
  ...
  using is_vertex_bundle =
      is_convertible<typename vebl_d_ary_tree<Arity, VertexProperties,
                                              EdgeProperties>::vertex_bundled*,
                     non_const_Bundle*>;
  using type = bundle_member_property_map<
      non_const_T, vebl_d_ary_tree<Arity, VertexProperties, EdgeProperties>,
      typename mpl::if_<is_vertex_bundle, vertex_bundle_t,
                        edge_bundle_t>::type>;
  using const_type = bundle_member_property_map<
      const non_const_T,
      const vebl_d_ary_tree<Arity, VertexProperties, EdgeProperties>,
      typename mpl::if_<is_vertex_bundle, vertex_bundle_t,
                        edge_bundle_t>::type>;
};

template <BGL_VEBL_D_ARY_TREE_ARGS, typename T, typename Bundle>
typename property_map<BGL_VEBL_D_ARY_TREE, T Bundle::*>::type get(
    T Bundle::*p, BGL_VEBL_D_ARY_TREE& g) {
  return typename property_map<BGL_VEBL_D_ARY_TREE, T Bundle::*>::type(&g, p);
}

template <BGL_VEBL_D_ARY_TREE_ARGS, typename T, typename Bundle>
typename property_map<BGL_VEBL_D_ARY_TREE, T Bundle::*>::const_type get(
    T Bundle::*p, const BGL_VEBL_D_ARY_TREE& g) {
  return typename property_map<BGL_VEBL_D_ARY_TREE, T Bundle::*>::const_type(&g,
                                                                             p);
}
...
typename property_map<BGL_VEBL_D_ARY_TREE, Property>::type get(
    Property p, BGL_VEBL_D_ARY_TREE& g) {
  using Map = typename property_map<
      vebl_d_ary_tree<Arity, VertexProperties, EdgeProperties>, Property>::type;
  return Map(&g, p);
}

template <BGL_VEBL_D_ARY_TREE_ARGS, typename Property>
typename property_map<BGL_VEBL_D_ARY_TREE, Property>::const_type get(
    Property p, const BGL_VEBL_D_ARY_TREE& g) {
  using Map = typename property_map<
      vebl_d_ary_tree<Arity, VertexProperties, EdgeProperties>,
      Property>::const_type;
  return Map(&g, p);
...
typename property_map_value<BGL_VEBL_D_ARY_TREE, Property>::type get(
    Property p, const BGL_VEBL_D_ARY_TREE& g, const Key& k) {
