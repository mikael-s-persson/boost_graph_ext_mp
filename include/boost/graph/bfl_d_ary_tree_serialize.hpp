...
inline void save(Archive& ar, const boost::bfl_d_ary_tree<Arity, VP, EP>& graph,
                 const unsigned int file_version) {
  boost::graph::detail::save_tree(ar, graph, file_version);
}

template <typename Archive, std::size_t Arity, typename VP, typename EP>
inline void load(Archive& ar, boost::bfl_d_ary_tree<Arity, VP, EP>& graph,
                 const unsigned int file_version) {
  boost::graph::detail::load_tree(ar, graph, file_version);
}

template <typename Archive, std::size_t Arity, typename VP, typename EP>
inline void serialize(Archive& ar, boost::bfl_d_ary_tree<Arity, VP, EP>& graph,
                      const unsigned int file_version) {
